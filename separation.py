...
"""
	Xihan Qin:
	The code is from Paper "Uncovering Disease-Disease Relationships Through The Human Interactome"
    by Joerg Menche, Amitabh Sharma, Maksim Kitsak, Susan Dina Ghiassian,
    Marc Vidal, Joseph Loscalzo & Albert-Laszlo Barabasi

	This file is modified to run with python 3:
    1. print statement,
    2. 'dict' object has no attribute 'has_key' issue

    nx related code are modified to keep up with the updated nx package
	1. self-loop removal

	print statements are commented out in function read_gene_list

	The code is kept as much as the original as possible
"""
